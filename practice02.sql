...
select e.EMPLOYEE_ID as 사번, (e.FIRST_NAME || ' ' || e.LAST_NAME) as 이름
  ...
  where jh.JOB_ID = j.JOB_ID and e.EMPLOYEE_ID = jh.EMPLOYEE_ID and j.JOB_TITLE = 'Public Accountant';
...
조회하세요 */ 
select e.EMPLOYEE_ID as 사번, e.LAST_NAME as 성, e.HIRE_DATE as 채용일
